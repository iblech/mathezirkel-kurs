...
\newcommand{\rueckseite}{
  \begin{minipage}[t][4cm][t]{7.6cm}
    ...
    Wenn~$n$ Mathematiker*innen ihre Namen auf Zettel schreiben, die Zettel mischen und dann
    ...
    \textbf{Offene Frage:} Ist~$e^e$ rational, irrational oder sogar
    transzendent?
    \scalebox{0.7}{\begin{minipage}{0.71\textwidth}\vspace*{-1em}
      \[ e = 1 + 1 + \frac{1}{1 + \frac{1}{2 + \frac{1}{1 + \frac{1}{1 +
      \frac{1}{4 + \frac{1}{1 + \frac{1}{1 + \frac{1}{6 + \cdots}}}}}}}} \]
    \end{minipage}\begin{minipage}{0.71\textwidth}\vspace*{-1em}
    \begin{align*}
