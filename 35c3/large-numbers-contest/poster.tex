...
\begin{tikzpicture}[remember picture,overlay]
  ...
  \node[anchor=south west] at ([yshift=-5cm]current page.south west) {\includegraphics[width=\paperwidth]{sun3}};
...
solution and award ceremony on day four at 12:55 in room M1: \\
\mbox{\includegraphics[height=0.8em]{scream} \textbf{large
numbers, very large numbers and very very large numbers}
\includegraphics[height=0.8em]{scream}} \\
organized by your Wondrous Mathematics team
