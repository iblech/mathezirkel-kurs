...
{\usebackgroundtemplate{\begin{minipage}{\paperwidth}\vspace*{0.3cm}\centering\scriptsize\sieve{2}{2}\\\vspace*{3.95cm}\includegraphics[width=\paperwidth]{sun3}\end{minipage}}
\begin{frame}[c]
  \centering
...
\begin{frame}
  ...
  \Huge \hil{Large number contest}

  \bigskip
  \Large\textbf{award ceremony}
  \par
  \bigskip
  \normalsize
...
3 !!! 3 = 3 !! (3 !! 3) = 3 !! 3^{27} = 3^3^... (3^27 viele Dreier)
