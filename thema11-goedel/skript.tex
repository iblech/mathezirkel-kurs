...
\section{Lösungen zu Übungsaufgaben}

\subsection{Lösung zu Aufgabe~\ref{aufg:bb} (Unberechenbarkeit der
Fleißiger-Biber-Funktion)}

\loesung{Angenommen, es gibt ein Programm, dass die Fleißiger-Biber-Funktion
berechnet. Dann können wir mit dessen Hilfe ein Halteorakel programmieren.
\begin{listing}
...
* Diskussion des Zufallscharakters von Omega: Programme, die die ersten N
  ...
  * Bilder von Fraktalen
    http://www.dvice.com/sites/dvice/files/Fractal3.jpg
    http://upload.wikimedia.org/wikipedia/commons/8/8b/Fractal_KRkr_City1_5600.jpg
