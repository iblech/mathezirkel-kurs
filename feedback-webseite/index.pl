...
my %courses = (
  ...
  a_06 => {
    name => "Korrespondenzzirkel bei Veronika und Lisa (6. Klasse)",
    text => KORRESPONDENZ,
    mail => 'veronika.auer@math.uni-augsburg.de,reischmann_lisa@yahoo.de',
    anrede => "Liebe Veronika, liebe Lisa",
    gruss  => ANON_GRUSS,
  },
  a_07 => {
    name => "Korrespondenzzirkel bei Jorid (7. Klasse)",
    text => KORRESPONDENZ,
    mail => 'jorid.kretzschmar@aol.de',
    anrede => "Lieber Ralph",
    gruss  => ANON_GRUSS,
  },
  a_08 => {
  ...
  a_09 => {
    name => "Korrespondenzzirkel bei Gabi und Inga (9. Klasse)",
    text => KORRESPONDENZ,
    mail => 'mij@muetzelfeldt.de',
    anrede => "Liebe Gabi, liebe Inga",
    gruss  => ANON_GRUSS,
  },
  a_10 => {
    name => "Korrespondenzzirkel bei Kathrin (10. Klasse)",
    text => KORRESPONDENZ,
  ...
  a_11 => {
    name => "Korrespondenzzirkel bei Gesa und Moritz (11. Klasse)",
    text => KORRESPONDENZ,
    mail => 'moritz.oli3@hotmail.com,gscupin@gmx.de',
    anrede => "Liebe Gesa, lieber Moritz",
    gruss  => ANON_GRUSS,
  },
  a_12 => {
    name => "Korrespondenzzirkel bei Eric (12. Klasse)",
    text => KORRESPONDENZ,
    mail => 'eric.schlarmann@math.uni-augsburg.de',
    anrede => "Lieber Eric",
    gruss  => ANON_GRUSS,
  },
  b_56 => {
    name => "Präsenzzirkel bei Christian (5./6. Klasse, Fr 16:15)",
    text => PRAESENZ,
    mail => 'gross90christian@googlemail.com',
    anrede => "Lieber Christian",
    gruss  => ANON_GRUSS,
  },
  b_67 => {
    name => "Präsenzzirkel bei Andrea und Sadde (6./7. Klasse, Mo 17:15)",
    text => PRAESENZ,
    mail => 'andigeck@gmx.de,saadettinkaraca@hotmail.de',
    anrede => "Liebe Andrea, lieber Sadde",
    gruss  => ANON_GRUSS,
  },
  b_78 => {
    name => "Präsenzzirkel bei Caren und Max (7./8. Klasse, Fr 16:00)",
    text => PRAESENZ,
    mail => 'caren.schinko@web.de,maxschloegel@gmx.net',
    anrede => "Liebe Caren, lieber Max",
    gruss  => ANON_GRUSS,
  },
  b_910a => {
    name => "Präsenzzirkel bei Andreas und Alexei (9./10. Klasse, Do 17:15)",
    text => PRAESENZ,
    mail => 'hohl.andreas@web.de,alexei.kudryashov@math.uni-augsburg.de',
    anrede => "Lieber Andreas, lieber Alexei",
    gruss  => ANON_GRUSS,
  },
  b_a112 => {
    name => "Präsenzzirkel bei Benedikt (11./12. Klasse, Fr 15:30)",
    text => PRAESENZ,
    mail => 'benedikt@aqtiv.de',
