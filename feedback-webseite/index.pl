...
# },
  ...
  a_05 => {
    name => "Präsenzzirkel bei Matthias H. und Samuel (5./6. Klasse, Di 17:15)",
    text => PRAESENZ,
  ...
  a_06 => {
    name => "Präsenzzirkel bei Carola und Matthias S. (5./6. Klasse, Mi 16:30)",
    text => PRAESENZ,
    mail => 'carola.sinz@gmx.de,matthias.schlueter-mp@web.de',
    anrede => "Liebe Carola, lieber Matthias",
    gruss  => ANON_GRUSS,
  },
  a_07 => {
    name => "Präsenzzirkel bei Benedikt und Max (7./8. Klasse, Fr 15:30)",
    text => PRAESENZ,
    mail => 'benedikt@von-seelstrang.de,maximilian1.bauer@student.uni-augsburg.de',
    anrede => "Lieber Benedikt, lieber Max",
    gruss  => ANON_GRUSS,
  },
  a_08 => {
    name => "Präsenzzirkel bei Andreas P. und Simone (9. Klasse, Mo 16:30)",
    text => PRAESENZ,
    mail => 'andreas.petrak@student.uni-augsburg.de,beyser.simone@gmail.com',
    anrede => "Lieber Andreas, liebe Simone",
    gruss  => ANON_GRUSS,
  },
  a_09 => {
    name => "Präsenzzirkel bei Andreas H. und David  (9./10. Klasse, Fr 17:15)",
    text => PRAESENZ,
  ...
  a_10 => {
    name => "Präsenzzirkel bei Ferdinand und Xaver (10./11./12. Klasse)",
    text => PRAESENZ,
    mail => 'ferdinand.eitler@gmx.de,hoe.dom@gmx.de',
    anrede => "Lieber Ferdinand, lieber Xaver",
    gruss  => ANON_GRUSS,
  },
  k_12 => {
    name => "Korrespondenzzirkel bei Rolf und Ingo (11./12. Klasse)",
    text => KORRESPONDENZ,
    mail => 'rkw95@web.de,iblech@web.de',
    anrede => "Lieber Rolf, lieber Ingo",
    gruss  => ANON_GRUSS,
  },
  k_10 => {
    name => "Korrespondenzzirkel bei Tanja und Christian (9./10. Klasse)",
    text => KORRESPONDENZ,
    mail => 'lochner.christian@gmx.net,tanja.wolfer@gmx.de',
    anrede => "Liebe Tanja, lieber Christian",
    gruss  => ANON_GRUSS,
  },
  k_08 => {
    name => "Korrespondenzzirkel bei Tobias und Anna (7./8. Klasse)",
    text => KORRESPONDENZ,
    mail => 'tobias@arndts-online.de,anna-rubeck@web.de',
    anrede => "Lieber Tobias, liebe Anna",
    gruss  => ANON_GRUSS,
  },
  k_06 => {
    name => "Korrespondenzzirkel bei Dominik und Lukas (5./6. Klasse)",
    text => KORRESPONDENZ,
