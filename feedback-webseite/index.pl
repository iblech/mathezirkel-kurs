...
# },
  a_05a => {
    ...
    text => PRAESENZ,
    mail => 'anja.draser@t-online.de,barbarak1705@gmail.com',
    anrede => "Liebe Anja, liebe Barbara",
    gruss  => ANON_GRUSS,
  },
  a_05b => {
    name => "Präsenzzirkel bei Alex und Felix (5./6. Klasse, Fr 17:15)",
    text => PRAESENZ,
    mail => 'alex.m.s@gmx.de,felixstaerk@gmail.com',
    anrede => "Lieber Alex, lieber Felix",
    gruss  => ANON_GRUSS,
  },
  a_07a => {
    name => "Präsenzzirkel bei Benedikt und Jana (7./8. Klasse, Mo 17:30)",
    text => PRAESENZ,
    mail => 'benedikt@von-seelstrang.de,janarankl@web.de',
    anrede => "Lieber Benedikt, liebe Jana",
    gruss  => ANON_GRUSS,
  },
  a_07b => {
    name => "Präsenzzirkel bei Hanna und Louisa (7./8. Klasse, Mi 17:15)",
    text => PRAESENZ,
    mail => 'hanna.hochenbleicher@gmail.com,louisa.voelker@gmail.com',
    anrede => "Liebe Hanna, liebe Louisa",
    gruss  => ANON_GRUSS,
  },
  a_09 => {
    name => "Präsenzzirkel bei Dominik und Stefan (9./10. Klasse, Mi 15:45)",
    text => PRAESENZ,
    mail => 'd.schmucker1995@gmail.com,stefanrandelzhofer@gmail.com',
    anrede => "Lieber Dominik, lieber Stefan",
    gruss  => ANON_GRUSS,
  },
  a_10 => {
    name => "Präsenzzirkel bei Ferdinand, Lorena und Xaver (10./11. Klasse, Fr 17:30)",
    text => PRAESENZ,
    mail => 'ferdinand.eitler@gmx.de,lolo.kempter@gmx.de,hoe.dom@gmx.de',
    anrede => "Lieber Ferdinand, liebe Lorena, lieber Xaver",
    gruss  => ANON_GRUSS,
  },
  k_05 => {
    name => "Korrespondenzzirkel bei Sven (5. Klasse)",
    text => KORRESPONDENZ,
  ...
  k_08 => {
    name => "Korrespondenzzirkel bei Matthias (8. Klasse)",
    text => KORRESPONDENZ,
  ...
  k_09 => {
    name => "Korrespondenzzirkel bei Caterina (9. Klasse)",
    text => KORRESPONDENZ,
    mail => 'caterina.cozzi@gmail.com',
    anrede => "Liebe Caterina",
    gruss  => ANON_GRUSS,
  },
  k_10 => {
    name => "Korrespondenzzirkel bei Kilian (10. Klasse)",
    text => KORRESPONDENZ,
    mail => 'kilian.ruess@student.uni-augsburg.de',
    anrede => "Lieber Kilian",
    gruss  => ANON_GRUSS,
  },
  k_11 => {
    name => "Korrespondenzzirkel bei Julius (11. Klasse)",
    text => KORRESPONDENZ,
    mail => 'julius.natrup@math.uni-augsburg.de',
    anrede => "Lieber Julius",
    gruss  => ANON_GRUSS,
  },
);
