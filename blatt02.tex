...
\usepackage{lscape}
\newcommand{\head}[1]{\begin{center}\large \textbf{#1}\end{center}}
\begin{document}
...
Verlierer ist derjenige, der keinen Zug mehr tätigen kann. Die jeweils
vorliegende Spielsituation, genannt \emph{Position}, wollen wir
mathematisch mit sog. \emph{Games} beschreiben, einer
leichten Verallgemeinerung der surrealen Zahlen.
Die Konstruktionsregel der Games ist im Vergleich zur surrealen Variante freigiebiger:
