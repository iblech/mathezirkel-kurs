...
\vspace*{-1em} \\
\textbf{Schuljahresausklangsmitmachvortrag am 27. Juli 2022} \\
\emph{Fragen sind jederzeit willkommen! Bitte nicht bis zum Ende aufsparen.} \\
\medskip
Kathrin Gimmi und Alexander Mai \qquad\qquad\qquad Matthias Hutzler \\
{\quad\qquad\qquad} Universität Augsburg \ \qquad\qquad\qquad University of Gothenburg}
...
\begin{frame}{4d-Würfel!!!!}
  \centering
  \includegraphics[height=0.8\textheight]{4d-tesseract-hype}
\end{frame}
