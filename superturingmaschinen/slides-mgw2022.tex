...
\author[Ingo Blechschmidt]{\textcolor{white}{Weihnachtsvorlesung
\\ 21. Dezember 2022}}
\date[2022-12-21]{\vspace*{5.5em}\ \\\small\textcolor{white}{Ingo Blechschmidt \\ \scriptsize
}}
...
\begin{frame}[plain]
  \vspace*{6cm}\hspace*{5.7cm}\begin{minipage}{4.7cm}
    \Large\hil{Ada Lovelace},

    \large
    \mbox{die erste programmierende} \\
    Person der Welt
    \medskip
...
— Bei Vielzahl von Spaßfragen mit Spaßantworten Fragen, die ernst gemeint sind,
  nicht verchecken

— Schneller Ordinalzahlen abhandeln, mehr auf Besonderheiten eingehen (wie
  fehlende Kommutativität)

— Anwendungen

— Leute nach vorne holen, wenn sie nach dem Vortrag noch Fragen haben, und zwar
  in Halbkreisform statt Schlange, damit sie die anderen Fragen und Antworten gut
  verstehen können

— Mehr Mathe-Creds etablieren, nicht zu sehr als Hampel selbst degradieren

— Mehr Verständnis-/Überlegfragen ans Publikum stellen (natürlich nicht
  oberlehrerhaft)

— Am Ende Übungsaufgaben/Linkliste o.Ä. für Interessierte verteilen
