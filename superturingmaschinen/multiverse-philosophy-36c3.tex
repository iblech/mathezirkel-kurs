...
\begin{frame}{An outline of \ZFC}
  ...
  \textbf{Ex.} $\ZFC \vdash 2+2=4$, $\ZFC \vdash 2+2\neq5$,
  $\ZFC \not\vdash 2+2=5$.
\end{frame}
...
\begin{frame}{Foundational incompleteness}
  ...
  \begin{hilblock}\justifying
    ...
    Then there are mathematical statements~$\varphi$ such that, if~$S \vdash
    \varphi$ or if~$S \vdash \neg\varphi$ (the
...
{\usebackgroundtemplate{\begin{minipage}{\paperwidth}\centering\includegraphics[height=\paperheight]{geology-light}\end{minipage}}
