...
\begin{frame}{Größenvergleiche im Unendlichen}
  ...
  \begin{itemize}
    \item die Menge~$\mathbb{N}$ der natürlichen Zahlen: \tabto{6.5cm}$0,\ 1,\ 2,\ \ldots$
    \item die Menge~$\mathbb{Z}$ der ganzen Zahlen: \tabto{6.5cm}$\ldots,\ -2,\ -1,\ 0,\ 1,\ 2,\ \ldots$
  \end{itemize}
  \pause
  \bigskip
...
\begin{frame}{Größenvergleiche im Unendlichen}
  Die beiden Mengen sind \hil{gleich groß}.
  \bigskip
  ...
  \raggedright\bigskip
  Es gibt \hil{genauso viele} natürliche Zahlen wie ganze Zahlen.
\end{frame}
...
\begin{frame}{Wie viele reelle Zahlen gibt es?}
  ...
  \begin{itemize}
    \item die Menge~$\mathbb{N}$ der natürlichen Zahlen: \tabto{6.5cm}$0,\ 1,\ 2,\ \ldots$
    \item die Menge~$\mathbb{R}$ der reellen Zahlen: \tabto{6.5cm}$0{,}25,\ \tfrac{1}{3},\ \pi,\ \sqrt{2},\ \ldots$
  \end{itemize}
  \pause

  Es gibt \hil{mehr} reelle Zahlen als natürliche.
  \pause
  \bigskip

  \centering
  \only<3>{\begin{tabular}{ccc}
    \uline{\quad alle nat. Zahlen \quad} && \uline{\quad viele reelle Zahlen \quad} \\
...
% Pferde: Tous les chevaux du roi y pourraient boire ensemble. (Alle Pferde des
% Königs können dort gemeinsam trinken.)

% Bei einer möglichen Wiederholung beachten:
% Betonen, dass Gleichmächtigkeit mit N bedeutet, dass es eine *vollendete*
% Liste alle reeller Zahlen gibt.
