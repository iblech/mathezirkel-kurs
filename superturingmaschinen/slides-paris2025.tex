...
\usepackage{calc}
\usepackage{ragged2e,wasysym,multicol,mathtools,booktabs,xspace,tabto}
...
% https://tex.stackexchange.com/a/198372/32372
% \includegraphics[width=3cm]{lovelace-babbage}
% \includegraphics[width=3cm]{first-program}
\addtocounter{framenumber}{-1}
{\usebackgroundtemplate{\begin{minipage}{\paperwidth}\includegraphics[height=\paperheight,valign=t]{ada-lovelace}\includegraphics[width=10.5cm,valign=t]{first-program}\end{minipage}}
\begin{frame}[plain]
  \vspace*{7.4cm}\hspace*{5cm}\begin{minipage}{8.7cm}
    \Large\hil{Ada Lovelace} (* 1815, † 1852),
...
\begin{frame}{Infinite time Turing machines}
  ...
  \begin{itemize}
    \item ordinary:\tabto{2.5cm} $0,\ 1,\ 2,\ \ldots$
    \item infinite time:\tabto{2.5cm} $0,\ 1,\ 2,\ \ldots,\ \omega,\ \omega + 1,\ \ldots,\ \omega\cdot2,\ \omega\cdot2 + 1,\
...
\begin{frame}{A question for you}
  \centering
  What is the behavior of this infinite time Turing machine?
...
\begin{frame}{Fun facts}
  \begin{itemize}
    ...
    \item Infinite time Turing machines can be \hil{simulated by
    ordinary~differential~equations} [Olivier Bournez, Sabrina Ouazzani]
  \end{itemize}
\end{frame}}
...
\begin{frame}{Wrapping up}
  ...
  \centering
  \bigskip
  \colorbox{white!70}{\hil{\textcolor{mypurple}{You are welcome to explore the
  toposophic landscape :-)}}}
  \par
\end{frame}}
