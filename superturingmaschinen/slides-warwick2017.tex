...
\begin{frame}{A question to you}
  ...
  \code{In the start state and the limit state, check whether the current cell contains an ``1''.
  \begin{itemize}
...
\begin{frame}{What can super Turing machines do?}
  ...
  \hil{But:} Super Turing machines can't calculate all functions
...
Unbedingt erwähnen: negneg-Modalität
