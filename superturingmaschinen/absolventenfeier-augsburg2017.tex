...
\author[Ingo Blechschmidt]{\small\ \\[-1em]\textcolor{white}{Absolventenfeier
\\[-0.2em] des Instituts für Mathematik \\[-0.2em] am 13. Oktober 2017}}
\date[2017-05-10]{\vspace*{6em}\ \\\textcolor{white}{\small Ingo Blechschmidt \\ \scriptsize
...
{\usebackgroundtemplate{\begin{minipage}{\paperwidth}\vspace*{1cm}\includegraphics[width=\paperwidth]{mensa-augsburg}\end{minipage}}
\begin{frame}
  \centering
  \bigskip
...
\begin{frame}
  ...
  \small
  {\centering\hil{Viel Freude beim weiteren Programm!}\par}
\end{frame}

{\usebackgroundtemplate{\begin{minipage}{\textwidth}\vspace*{0.4cm}\includegraphics[width=\paperwidth]{mathecamp-gruppenfoto-2017}\end{minipage}}
\begin{frame}[plain]
  \vspace{\textheight}\vspace{0.1em}\centering
  \hil{Mathecamp vom 18. bis 26. August in Violau}
  \par
\end{frame}}
