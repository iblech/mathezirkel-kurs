...
\begin{frame}{Wohlfundierung von Bäumen}
  Ein Baum ist genau dann \hil{wohlfundiert}, wenn er keinen unendlichen Pfad enthält.

  \begin{center}
    \scalebox{0.4}{\input{images/nonwellfounded-tree.pdf_t}}
  \end{center}

  Superturingmaschinen können die Wohlfundiertheit von Bäumen entscheiden.
\end{frame}
...
\begin{frame}{Wann halten Superturingmaschinen?}
  Schon nach \hil{abzählbar vielen} ($\aleph_0$ vielen) Schritten hält jede
...
\begin{frame}{\only<2->{Ausbrechen aus Wiederholungen}}
