...
\begin{frame}{LEM für Gleichheit reeller Zahlen}
  ...
  Umgekehrt kann man zu einer reelen Zahl~$x$ diejenige Turingmaschine
...
\note{\justifying
  ...
  Diese Surjektion, und auch jede andere, ist aber entweder berechenbar, daher
  nicht in~$\Eff(\TM)$ enthalten, oder zwar berechenbar, aber so beschaffen,
  dass es keinen berechenbaren Zeugen ihrer Surjektivitätgibt. Daher
