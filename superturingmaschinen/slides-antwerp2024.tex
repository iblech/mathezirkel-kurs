...
\author[Ingo Blechschmidt]{\textcolor{white}{Ingo Blechschmidt \\ \scriptsize University of Antwerp \\ December 2th, 2024}}
\date[2024-12-02]{}
...
\partslide{turing-machine}{width=0.4\paperwidth}{4.5cm}{II}{(Super) Turing machines}


\subsection[TM]{Basics on Turing machines}
...
\begin{frame}{Super Turing machines}
  ...
  On reaching a limit ordinal time step like~$\omega$ or~$\omega \cdot 2$, \ldots
  \pause
  \begin{itemize}
...
\begin{frame}{A question for you}
  ...
  \parbox{0.72\textwidth}{\centering\hil{Super Turing machines can break out of
...
\begin{frame}{The ef{}fective topos}
  ...
  \begin{tabular}{@{\!\!\!\!\!\!}l@{\,}lp{2.0cm}p{2.0cm}p{2.0cm}}
    \toprule
  ...
  computing~$f$. \\\ \\\ }}
  \only<6>{\sexpl{4}{There is a super Turing machine which, given a \emph{super} Turing machine
...
\begin{frame}{Curious size phenomena}
  \explanation{$\Eff(\STM) \models \text{``There exists an injection~$\RR \hookrightarrow
  \NN$.''}$}{There is a super Turing machine which inputs the source of a
  super Turing machine~$A$ representing a real number and
...
\begin{frame}{Wrapping up}
  \begin{itemize}
    ...
    \item Toposes also have a geometric flavour: \\
...
Perhaps next time include a summary slide like this?

* Every topos has its own idea of what the logical connectives mean and hence
  which statements are true.

* But the rules of constructive mathematics are valid in every topos.
