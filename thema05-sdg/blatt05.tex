...
%\begin{bem}Wenn man allgemein Mathematik ohne das Axiom vom ausgeschlossenen
%Dritten betreibt, so nennt man das \emph{intuitionistische} oder
%\emph{konstruktive Mathematik}. Praktische Bedeutung hat diese Form der
%Mathematik in der Informatik und Numerik. Es stellt sich nämlich heraus, dass
%man aus jedem Beweis einer Existenzbehauptung oder ein anderes Objekt mit einer
%gewissen Eigenschaft existiert --, welcher ohne das Axiom vom ausgeschlossenen
%Dritten geführt wird, ein Computerprogramm extrahieren kann, dass da
%\end{bem}
...
% XXX: Nichttrivialität des Faktums erklären: Analoges Faktum gilt nicht für
% beliebige neu ausgedachte Axiome.
...
% surreale Zahlen (Vorteil: Spiele)
% hyperreale Zahlen (Vorteil: Transferprinzip)
% gemeinsamer Nachteil/Eigenschaft: Infinitesimale Zahlen sind nicht nilpotent
% Nachteil SDG: keine klassische Logik

% allgemein über int. Logik erzählen
% Anwendungen in der Informatik und Numerik
% x^y-Beispiel
...
% Literatur: Mike Shulman, Andrej Bauer, Anders Kock, John Bell
